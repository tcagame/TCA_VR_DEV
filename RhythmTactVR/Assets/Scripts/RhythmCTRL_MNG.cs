...
//	public float VeloTimerRhythmRange;	//振りトリガーからリズムとしての有効時間
	...
	public float _thresholdSwing = 0.2f;// 振り判定時の閾値.
...
//        mng3Obj = GetComponent<ControllerMng3>();
	...
	/// </summary>
	/// <returns></returns>
	public float getAngularVelocityLength( ) {
		return Pre_angularVelocity.magnitude;
	}

	/// <summary>
	/// 振っている確認( Threshold Swingの数値以上で判定 ).
	/// </summary>
	/// <returns></returns>
	public bool isSwing( ) {
		return getAngularVelocityLength( ) > _thresholdSwing;
	}
}
