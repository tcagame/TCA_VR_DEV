	...
	protected virtual void updateRhythm( ) {
		...
		try {
			if ( _data.ma[ _index[ ( int )RHYTHM_TAG.MAIN ] ].frame == ( uint )_frame ) {
				...
				_index[ ( int )RHYTHM_TAG.MAIN ] += ( _index[ ( int )RHYTHM_TAG.MAIN ] < _data.ma.Length - 1 ) ? 1 : 0;	// インデックスのオーバーの抑制
			} else {
        ...
        try {
			if ( _data.sb[ _index[ ( int )RHYTHM_TAG.SUB ] ].frame == ( uint )_frame ) {
				...
				_index[ ( int )RHYTHM_TAG.SUB ] += ( _index[ ( int )RHYTHM_TAG.SUB ] < _data.sb.Length - 1 ) ? 1 : 0;	// インデックスのオーバーの抑制
			} else {
        ...
        try {
			if ( _data.vo[ _index[ ( int )RHYTHM_TAG.VOCAL ] ].frame == ( uint )_frame ) {
				...
				_index[ ( int )RHYTHM_TAG.VOCAL ] += ( _index[ ( int )RHYTHM_TAG.VOCAL ] < _data.vo.Length - 1 ) ? 1 : 0;	// インデックスのオーバーの抑制
			} else {
        ...
        try {
			if ( _data.md[ _index[ ( int )RHYTHM_TAG.MODE_CHANGE ] ].frame == ( uint )_frame ) {
				...
				_index[ ( int )RHYTHM_TAG.MODE_CHANGE ] += ( _index[ ( int )RHYTHM_TAG.MODE_CHANGE ] < _data.md.Length - 1 ) ? 1 : 0;	// インデックスのオーバーの抑制
			} else {
        ...
        try {
			if ( _data.ga[ _index[ ( int )RHYTHM_TAG.GROUP_ANIM ] ].frame == ( uint )_frame ) {
				...
				_index[ ( int )RHYTHM_TAG.GROUP_ANIM ] += ( _index[ ( int )RHYTHM_TAG.GROUP_ANIM ] < _data.ga.Length - 1 ) ? 1 : 0;	// インデックスのオーバーの抑制
			} else {
